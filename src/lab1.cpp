...
int main()
{
    ...
    {
        Rect r1;
        //I'm defult constructor [0x7fffffffdfb0] (r1)
        Rect *pR = new Rect(1,2,1,2);   
        //I'm constructor [0x55555556b6c0] (pR)
        {
            Rect r2(r1);
            //I'm copy constructor [0x7fffffffdfc0] (r2)
            Rect arRect[2];
            //I'm defult constructor [0x7fffffffdff0] (arRect[1])
            // I'm defult constructor [0x7fffffffe000] (arRect[2])
            for(int i = 0; i < 3; i++)
            {
                static Rect r3 (i,i,i,i) ;
                // I'm constructor [0x555555558160] (r3)
                Rect r4(*pR);
                //I'm copy constructor [0x7fffffffdfd0] (r4)*3
                Rect r5(i,i,i,i);
                //I'm constructor [0x7fffffffdfe0] (r5)*3
            }//I'm destructor [0x7fffffffdfe0] (r4)*3
             //I'm destructor [0x7fffffffdfd0] (r5)*3
        }
         //I'm destructor [0x7fffffffdff0] (arRect[1])
         //I'm destructor [0x7fffffffe000] (arRect[2])
          //I'm destructor [0x7fffffffdfc0] (r2)
        delete pR;  
    } //I'm destructor [0x55555556b6c0] (pR)
     //I'm destructor [0x7fffffffdfb0] (r1)
    // construct: 12 destructor: 11 (r3 -- static)
     ...
     */
    // Функция-член имеет доступ к указателю на экземпляр класса
    /**
